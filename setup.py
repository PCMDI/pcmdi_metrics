...
setup (name = "pcmdi_metrics",
       ...
       data_files = [('share/pcmdi',('doc/obs_info_dictionary.json',)),
                     ('doc',('doc/pcmdi_metrics_input_parameters_sample.py',)),
                     ('test/pcmdi',('test/pcmdi/basic_test_parameters_file.py','test/pcmdi/tos_GFDL-ESM2G_Omon_historical_r1i1p1_198501-200512-clim.nc','test/pcmdi/sftlf_GFDL-ESM2G_fx_historical_r0i0p0_198501-200512-clim.nc','test/pcmdi/tos_2.5x2.5_esmf_linear_pcmdi_metrics.json.good')),
