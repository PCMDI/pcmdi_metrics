...
onemod_file = '/work/gleckler1/processed_data/metrics_package/metrics_results/sampletest1/tas_2.5x2.5_regrid2_linear_metrics.json'

### READ JSON FILE CONTAING RESULTS FROM A CMIP DATABASE 
cmipmods_file = '/work/gleckler1/processed_data/metrics_package/metrics_results/cmip5_test/tas_2.5x2.5_regrid2_linear_metrics.json'
...
# PCMDI METRICS PACKAGE STORES INFORMATION IN NESTED DICTIONARIES. WE START WITH SIMPLE EXAMPLE.  
...
print  ''
print 'Using "type" function to show conversion of test1 from unicode to real via float(test1) ', type(test1),'  ',  type(float(test1))


print  ''
print 'Showing the source of the "default" observations: ', onemod_dic['CCSM4']['default']['source'] 

# FOR BASIC INFORMATION ON PYTHON DICTIONARIES SEE http://www.tutorialspoint.com/python/python_dictionary.htm
...
### NOTE CONVERTING FROM UNICODE TO BYTE STRINGS IS NOT NECESSARY WHEN ACCESSING KEYS IN DICTIONARIES. EITHER UNICODE OR ASCII CAN BE USED.  
