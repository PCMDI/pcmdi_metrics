...
modpath = "/work/lee1043/ESGF/xmls/cmip5/historical/day/pr/cmip5.%(model).%(exp).%(realization).day.pr.xml"
modpath_lf = "/work/lee1043/ESGF/xmls/cmip5/historical/fx/sftlf/cmip5.%(model).historical.r0i0p0.fx.sftlf.xml"
#moddir = "/p/user_pub/pmp/pmp_results/pmp_v1.1.2/additional_xmls/latest/v20231125/cmip5/historical/atmos/day/pr/"
#modpath = "/p/user_pub/pmp/pmp_results/pmp_v1.1.2/additional_xmls/latest/v20231125/cmip5/historical/atmos/day/pr/cmip5.%(model).%(exp).%(realization).day.pr.xml"
#modpath = moddir+"cmip5.%(model).%(exp).%(realization).day.pr.xml"
...
#pmprdir = "/home/dong12/PMP/pcmdi_metrics/doc/jupyter/Demo/demo_output/monsoon_sperber/Ex1_test"
...
#)
results_dir = 'demo_output/monsoon_sperber/Ex1_test'
