...
seasons   = 'DJF,MAM,JJA,SON,yearly,monthly'.split(",")
frequency = 'mo'
...
obs_file = "ts_ref_variability_modes_atm_catalogue.json"
...
variability_mode = "NAM" #NAO,PNA,NPO,SAM,PSA1,PSA2
eofn_mod = "1" #"1,1,2,1,2,3"
eofn_obs = "1" #"1,1,2,1,2,3"
