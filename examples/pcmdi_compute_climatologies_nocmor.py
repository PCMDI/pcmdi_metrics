...
# lst = lst[0:2]
    ...
    for l in lst:
        ...
        try:
            ...
            timelbds = [(0, 31), (31, 60), (60, 91), (91, 121), (121, 152), (152, 182,),
                        (182, 213), (213, 244), (244, 274), (274, 305), (305, 335), (335, 366)]
            ta = cdms2.createAxis(timel, id='time')
...
##################
            ...
            # 1980-2005_AC.nc')
            gc = string.replace(l, '.xml', '.' + `by` + '-' + `ey` + '.AC.nc')
...
#    gs.close() # NEEDED FOR SEASONAL (SC)
            ...
            outlog = l, ' --> ', d.shape, '  ', c[0].year, ' ', c[0].month, ' to ', c[nt -
                                                                                      1].year, ' ', c[nt-1].month, ' --- ', c[0], '   ', c[nt-1], ' ', d.shape[0]/12., '  ', t2-t1
            print(outlog)
