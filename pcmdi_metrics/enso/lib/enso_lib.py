...
def AddParserArgument():
    ...
    P.add_argument(
        "--modnames", type=str, nargs="+", default=None, help="List of models"
    )
    P.add_argument(
        "-r",
        "--realization",
    ...
    P.add_argument(
        "--json_name", type=str, dest="json_name", help="File name for output JSON"
    )
    P.add_argument(
        "--netcdf_name",
        type=str,
...
def metrics_to_json(
    ...
    if mc_name == "MC1":
        reference = (
            "The statistics in this file are based on Bellenger et al. "
    ...
    OUT2 = pcmdi_metrics.io.base.Base(
        outdir(output_type="metrics_results"), json_name + "_diveDown.json"
    )
    OUT2.write(
        dict_dive,
        json_structure=["type", "data", "metric", "item", "value or description"],
...
def CLIVAR_LargeEnsemble_Variables():
    dict_cmip_variables = {
        ...
        "variable_name_in_file": {
            ...
            "lwr": {
                "var_name": "flns",
                "cf_name": "net_longwave_flux_at_surface",
                "cf_units": "W m-2",
            },
            # Rainfall Flux
            "pr": {
            ...
            "slp": {
                "var_name": "psl",
                "cf_name": "air_pressure_at_sea_level",
                "cf_units": "Pa",
            },
            ...
            "swr": {
                "var_name": "fsns",
                "cf_name": "net_shortwave_flux_at_surface",
                "cf_units": "W m-2",
            },
