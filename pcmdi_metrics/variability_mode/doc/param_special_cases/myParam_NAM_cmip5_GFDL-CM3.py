...
#modpath = '/work/lee1043/ESGF/CMIP6/CMIP/GFDL-CM4/piControl/%(mip).%(model).piControl.%(realization).mon.%(variable).nc'
modpath = '/work/lee1043/ESGF/CMIP5/GFDL-CM3/piControl/%(mip).%(model).piControl.%(realization).mon.%(variable).nc'
...
case_id = "{:v%Y%m%d}-3".format(datetime.datetime.now())
results_dir = os.path.join(
    #'/p/user_pub/pmp/pmp_results/pmp_v1.1.2',
    #'/work/lee1043/cdat/pmp/variability_mode/cmip6_GFDL-CM4_piControl_result',
    '/work/lee1043/cdat/pmp/variability_mode/cmip5_GFDL-CM3_piControl_result',
