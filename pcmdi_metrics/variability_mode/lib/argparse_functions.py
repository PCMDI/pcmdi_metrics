...
def AddParserArgument(P):
    ...
    P.add_argument(
        "--seasons", type=str, nargs="+", default=None, help="List of seasons"
    )
    P.add_argument(
        "--modnames",
        type=str,
    ...
    P.add_argument(
        "--oeyear", type=int, default=2005, help="End year for reference data"
    )
    P.add_argument("--msyear", type=int, default=1900, help="Start year for model(s)")
    P.add_argument("--meyear", type=int, default=2005, help="End year for model(s)")
