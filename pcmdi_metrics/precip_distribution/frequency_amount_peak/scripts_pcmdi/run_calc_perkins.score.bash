...
# nohup python -u ./calc_perkins.score.py --ref $ref --modpath "$modpath" --results_dir $results_dir  > ./log/log_calc_perkins.score &
...
# nohup python -u ./calc_perkins.score.py --ref $ref --modpath "$modpath" --results_dir $results_dir  > ./log/log_calc_perkins.score_obs &
