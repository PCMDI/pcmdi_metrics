...
with open('../param/dist_freq_amount_peak_width_params_'+mip+'.py') as source_file:
...
for ifl, fl in enumerate(file_list):
    file = fl.split('/')[-1]
    cmd_list.append('python -u ../dist_freq_amount_peak_width_driver.py -p ../param/dist_freq_amount_peak_width_params_'+mip+'.py --mod '+file)
