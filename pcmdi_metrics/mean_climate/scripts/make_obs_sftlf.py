...
File was created to generate land-sea masks
for various reanalysis datasets, obtained from a range
of different sources both
land-sea masks and land-only variables (as available)
