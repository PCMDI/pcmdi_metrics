...
P.add_argument("--modpath", type=str, dest="modpath", default=None, help="path+file")

P.add_argument(
    "--realization", type=str, dest="realization", default=None, help="path+file"
)

P.add_argument("--mod_name", type=str, dest="mod_name", default=None, help="path+file")
...
for mod in [mod_name]:
    ...
    if hasattr(tt, "calendar"):
        ...
        if tt.calendar == "gregorian":
            cdtime.DefaultCalendar = cdtime.MixedCalendar
        if tt.calendar == "365_day":
            cdtime.DefaultCalendar = cdtime.NoLeapCalendar
        if tt.calendar == "noleap":
            cdtime.DefaultCalendar = cdtime.NoLeapCalendar
        if tt.calendar == "proleptic_gregorian":
            cdtime.DefaultCalendar = cdtime.GregorianCalendar
        if tt.calendar == "standard":
            cdtime.DefaultCalendar = cdtime.StandardCalendar
