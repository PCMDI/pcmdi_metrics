...
metrics_output_path = "giss-pr-nonst/"

#test_data_set = ["MIROC6","GISS-E2-1-G"]
test_data_set = ["GISS-E2-2-G"]
#test_data_set = ["CESM2"]
realization = ["r1i1p1f1","r1i1p3f1"]
...
covariate_path = "/home/ordonez4/git/pcmdi_metrics/pcmdi_metrics/extremes/co2_annual_1950-1999.nc"
