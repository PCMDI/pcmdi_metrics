...
def get_assessed_fbks(fbk_dict, obsc_fbk_dict):
    ...
    LW = (
        obsc_fbk_dict["eq30"]["ocn_dsc"]["LO680"]["LWcld_amt"]
        + obsc_fbk_dict["eq30"]["ocn_dsc"]["LO680"]["LWcld_tau"]
    )
    SW = (
        obsc_fbk_dict["eq30"]["ocn_dsc"]["LO680"]["SWcld_amt"]
        + obsc_fbk_dict["eq30"]["ocn_dsc"]["LO680"]["SWcld_tau"]
    )
    assessed.append(LW + SW)
...
def get_unassessed_fbks(fbk_dict, obsc_fbk_dict):
    ...
    # ===========================================
    LW = (
        obsc_fbk_dict["eq90"]["all"]["LO680"]["LWcld_err"]
        + fbk_dict["eq90"]["all"]["HI680"]["LWcld_err"]
    )
    SW = (
        obsc_fbk_dict["eq90"]["all"]["LO680"]["SWcld_err"]
    ...
    LW_A = (
        obsc_fbk_dict["eq30"]["ocn"]["LO680"]["LWcld_amt"]
        + obsc_fbk_dict["eq30"]["ocn"]["LO680"]["LWcld_tau"]
        + fbk_dict["eq30"]["ocn"]["HI680"]["LWcld_amt"]
        + fbk_dict["eq30"]["ocn"]["HI680"]["LWcld_tau"]
        + obsc_fbk_dict["eq30"]["ocn"]["LO680"]["LWdobsc_fbk"]
    )
    SW_A = (
        obsc_fbk_dict["eq30"]["ocn"]["LO680"]["SWcld_amt"]
        + obsc_fbk_dict["eq30"]["ocn"]["LO680"]["SWcld_tau"]
        + fbk_dict["eq30"]["ocn"]["HI680"]["SWcld_amt"]
        + fbk_dict["eq30"]["ocn"]["HI680"]["SWcld_tau"]
        + obsc_fbk_dict["eq30"]["ocn"]["LO680"]["SWdobsc_fbk"]
    )
