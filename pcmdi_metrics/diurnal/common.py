...
P.add_argument(
    "-f", "--firstyear", type=int, default=1999, help="First year of data processing"
)
P.add_argument(
    "-l", "--lastyear", type=int, default=2005, help="Last year of data processing"
)
P.add_argument("-r", "--realization", default="r1i1p1", help="Realization used")
...
P.add_argument("--skip", default=[], help="models to skip", nargs="*")
P.add_argument(
    "-a",
    "--append",
    default=False,
