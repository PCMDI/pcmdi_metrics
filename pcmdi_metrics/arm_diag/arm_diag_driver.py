...
arm_driver_path = (
    pmpcode_path + "/pcmdi_metrics/arm_diag/arm-gcm-diagnostics/arm_diags/arm_driver.py"
)
user_arm_driver_json_path = (
    pmpcode_path
    + "/pcmdi_metrics/arm_diag/arm-gcm-diagnostics/arm_diags/diags_all_multisites_for_cmip6.json"
)
...
user_data_base_path = (
    "/global/cfs/cdirs/mp193/PMP_ARMDiag/ARM_DATA/arm_diags_data_v4.0_09242024/"
)
...
default_armdiags_path = (
    "/Users/tao4/Documents/ARM_Infrastructure/ARM_DIAG/arm-gcm-diagnostics/"
)
default_test_data_set = "testmodel"
default_data_base_path = (
    "/Users/tao4/Documents/ARM_Infrastructure/ARM_DIAG/arm_diags_data_v3.1_06122023/"
)
...
basic_para_path = (
    pmpcode_path
    + "/pcmdi_metrics/arm_diag/arm-gcm-diagnostics/arm_diags/basicparameter.py"
)
...
replace_text_in_file(
    arm_driver_path, default_arm_driver_json_name, user_arm_driver_json_path
)
