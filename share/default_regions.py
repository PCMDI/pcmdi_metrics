...
regions_specs = {
        ...
        "global" : {},
        '90S-50S' : {'domain':cdutil.region.domain(latitude=(-90.,-50,'ccb'))},
        '50S-20S' : {'domain':cdutil.region.domain(latitude=(-50.,-20,'ccb'))},
        '20S-20N': {'domain':cdutil.region.domain(latitude=(-20.,20,'ccb'))},
        '20N-50N' : {'domain':cdutil.region.domain(latitude=(20.,50,'ccb'))},
        '50N-90N' : {'domain':cdutil.region.domain(latitude=(50.,90,'ccb'))},
