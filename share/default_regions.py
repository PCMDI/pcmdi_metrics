...
regions_specs = {
    ...
    # Below is for monsoon domains
        ...
        'NAMM' :{'domain':cdutil.region.domain(latitude=(0.,45.,'ccb'),longitude=(210.,310.,'ccb'))}, # North American Monsoon
        'SAMM' :{'domain':cdutil.region.domain(latitude=(-45.,0.,'ccb'),longitude=(240.,330.,'ccb'))}, # South American Monsoon
